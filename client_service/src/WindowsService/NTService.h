...
public:		// overridables
    ...
    //		arguments !
    virtual BOOL	RegisterService(int argc, _TCHAR ** argv);
    ...
    virtual BOOL	DebugService(int argc, _TCHAR **argv,BOOL faceless=FALSE);	//!! TCW MOD - added FACELESS parm to allow Win95 usage.

protected:	// implementation
    void QueryServicePath(TCHAR szPath[]);
