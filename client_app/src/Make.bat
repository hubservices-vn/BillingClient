...
set ProjFile=gbClientApp.vcproj
...
set outputDir=%outputRootDir%\clientApp_%dt%_%VersionStr%
...
xcopy /Y /D /C /Q /R %binDir%\gbClientApp.exe %outputDir%
...
echo f | xcopy /Y /D /C /Q /R %commonDir%\Version\version.tag %outputDir%\version_ClientApp.tag
...
CALL %SignToolDir%\sign_hoabinh.bat %binInstallDir%\gbClientApp.exe
CALL %SignToolDir%\sign_hoabinh.bat %binInstallDir%\clientupdatelib.dll
CALL %SignToolDir%\sign_hoabinh.bat %binInstallDir%\clientupdater.exe
CALL %SignToolDir%\sign_hoabinh.bat %binInstallDir%\gInitTool.exe
CALL %SignToolDir%\sign_hoabinh.bat %binInstallDir%\prochost.dll
CALL %SignToolDir%\sign_hoabinh.bat %binInstallDir%\x86\prochook.dll
CALL %SignToolDir%\sign_hoabinh.bat %binInstallDir%\x86\prochost.dll
CALL %SignToolDir%\sign_hoabinh.bat %binInstallDir%\x86\stub\prochook.dll
CALL %SignToolDir%\sign_hoabinh.bat %binInstallDir%\x64\prochook.dll
CALL %SignToolDir%\sign_hoabinh.bat %binInstallDir%\x64\prochost.dll
CALL %SignToolDir%\sign_hoabinh.bat %binInstallDir%\x64\stub\prochook.dll

rem also backup the pdb 
xcopy /Y /D /C /Q /R %binDir%\gbClientApp.pdb %outputDir%
...
COLOR 0C
echo -----------------------------ERROR -----------------------------
echo  Build client app failed, read "CZUniqueBuildLogs.logcz" for details
echo -----------------------------ERROR -----------------------------
rem goto end
popd
endlocal
