...
**
** Created: Wed Jul 25 22:36:09 2012
...
"}"));
    ...
    {
        QcIPWidget->setWindowTitle(QApplication::translate("QcIPWidget", "Form", 0, QApplication::UnicodeUTF8));
        label->setText(QApplication::translate("QcIPWidget", ".", 0, QApplication::UnicodeUTF8));
        label->setProperty("category", QVariant(QApplication::translate("QcIPWidget", "ipSeparator", 0, QApplication::UnicodeUTF8)));
        label_2->setText(QApplication::translate("QcIPWidget", ".", 0, QApplication::UnicodeUTF8));
        label_2->setProperty("category", QVariant(QApplication::translate("QcIPWidget", "ipSeparator", 0, QApplication::UnicodeUTF8)));
        label_3->setText(QApplication::translate("QcIPWidget", ".", 0, QApplication::UnicodeUTF8));
        label_3->setProperty("category", QVariant(QApplication::translate("QcIPWidget", "ipSeparator", 0, QApplication::UnicodeUTF8)));
    } // retranslateUi
