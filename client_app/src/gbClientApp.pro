...
#test
# The application revision No.
#HGID = $$system(hg id -n)
#VERSION = 0.1.$$system(hg log -r . --template {latesttagdistance})
...
INCLUDEPATH += .\
    ...
    $$TOOLS_DIR/updatev2/src/include/threelayerupdate \
    $$SHARED_COMMON_DIR/Cipher \
    $$SHARED_COMMON_DIR/Cmd \
    $$SHARED_COMMON_DIR/Data $$SHARED_COMMON_DIR/Data/cs2ss $$SHARED_COMMON_DIR/Data/ss2cs \
    $$SHARED_COMMON_DIR/Helper \
...
LIBS += wininet.lib Ws2_32.lib

CONFIG(debug, debug|release){
LIBS += \
    $$TOOLS_DIR/CcSDK/bin/debug/CcSDKd.lib \
    $$TOOLS_DIR/updatev2/src/debug/clientupdatelib.lib \
...
LIBS += \
    ...
    $$TOOLS_DIR/updatev2/src/release/clientupdatelib.lib \
...
RC_FILE = resource/clientApp.rc

OTHER_FILES += \
    resource/clientApp.rc
